...
(defn jar [_]
  ...
  (let [v (version)
    ...
    (b/write-pom {:class-dir class-dir
                  ...
                  :basis @basis
                  :src-dirs ["src"]
                  :scm {:url "https://github.com/replikativ/kabel-auth"
                        :connection "scm:git:git://github.com/replikativ/kabel-auth.git"
                        :developerConnection "scm:git:ssh://git@github.com/replikativ/kabel-auth.git"
                        :tag (b/git-process {:git-args "rev-parse HEAD"})}
                  :pom-data [[:description "Authentication and authorization middleware for kabel websocket connections."]
